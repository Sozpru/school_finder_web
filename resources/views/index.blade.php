                    ...
                    <ul class="pr-5">
                        ...
                        <li class="profile_photo">
                            ...
                            <a class="nav-link mb-2" data-toggle="modal" data-target="#profileModal" data-whatever="">
                                <img src="{{ (isset($side)) ? ((empty($side->image)) ? asset('assets/img/avatar.png') : asset($side->image) ) : asset('assets/img/avatar.png') }}" id="profileImages" height="100px" width="100px" class="shadow bg-white rounded-circle">
                            </a>
                            @endif
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-center">
                        ...
                        <h2>Let’s teach them, Start a teaching career, Become an Online School !</h2>
                        <div>
                            <div class="text-lg-start">
                                @if(session()->get('web_username') == '')
                                <a href=""  data-toggle="modal" data-target="#loginModal" data-whatever="" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                        ...
                        @if(session()->get('type') == '')
                        <h1>Find online School </h1>
                        <h2>A platform for Students & Schools to connect them!</h2>
                        <div>
                            <div class="text-lg-start">
                                @if(session()->get('web_username') == '')
                                <a href=""  data-toggle="modal" data-target="#loginModal" data-whatever="" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                    ...
                    <div class="bg-white top-rounded pt-4">
                        <center>
                            <label class="switch">
                                ...
                                <span class="absolute-no">School</span>
                            </label>
                        </center>
                ...
                <div class="modal-content bg-blue rounded-modal shadow p-3" style="margin-top: 4rem;">
                    ...
                    <div class="modal-body bg-white top-rounded mt-3">
                        ...
                        <form  class="mt-3"><center>
                                <div class="mb-5">
                                    <img src="{{ (isset($getdata)) ? ((empty($getdata[0]->image)) ? asset('assets/img/avatar.png') : asset($getdata[0]->image) ) : asset('assets/img/avatar.png') }}" id="profileImage" height="100px" width="100px" class="shadow bg-white rounded-circle" alt="">
...
//                alert(type);
                var dataString = 'email=' + email +'&password='+ password + '&type=' + type;
		$.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        }
