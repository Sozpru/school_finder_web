...
<div id="mySidenav" class="sidenav">
    <div class="textField-bg pt-5 d-flex align-items-center flex-column ml-n6">
        ...
        <a href="#" onclick="closeNav()" data-toggle="modal" data-target="#profileModal" data-whatever="">
            <img src="{{ (isset($side)) ? ((empty($side->image)) ? asset('assets/img/avatar.png') : asset($side->image) ) : asset('assets/img/avatar.png') }}" height="100px" width="100px" class="user-profile shadow  rounded-circle"/></a>
    ...
    <div class="mt-2">
        ...
        <a href="{{ url('Find_tutor') }}"><i class="bi bi-search h4 text-lighter mr-3"></i>Find School</a>
...
<div id="mySidenav" class="sidenav">
    <div class="textField-bg pt-5 d-flex align-items-center flex-column ml-n6">
        ...
        <a href="{{ url('Tutor_profile') }}" class="">
            <img src="{{ (isset($side)) ? ((empty($side->image)) ? asset('assets/img/avatar.png') : asset($side->image) ) : asset('assets/img/avatar.png') }}" class="user-profile shadow  rounded-circle"/></a>
