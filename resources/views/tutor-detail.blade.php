                        ...
                        <div class="col-lg-3 shadow rounded text-center">
                            <div class="mt-3">
                                <div class="swiper-wrapper d-flex justify-content-center">
                                    <img src="{{ (isset($getdata)) ? ((empty($getdata[0]->image)) ? asset('assets/img/avatar.png') : asset($getdata[0]->image)) : asset('assets/img/avatar.png') }}" height="200px" width="200px" class="shadow bg-white rounded-circle" alt="">
                                </div>
                            </div>
